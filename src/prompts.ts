...
1. **专业术语保持英文**
   API、LLM、FinTech、DeFi、blockchain、ML、AI、agent、RAG、microservices、cloud-native、Transformer、prompt、PostgreSQL、pattern、workflow 等术语保留原文，确保精确性。

2. **节奏从容，长短句结合**
   该舒展时舒展，该收束时收束。转折用"再比如""与此同时""所幸"等自然过渡，别让读者喘不过气。

3. **细节扎实**
   versioned 是"按版本"，proven 是"经过验证"，deep 是"深入"——词义要准确落地。数字、时间、地点等细节不能含糊，它们是文字的骨架。

4. **语气克制**
   ❌ "超级厉害" → ✅ "颇具价值"
   ❌ "非常牛" → ✅ "值得注意"
   不煽情、不夸张，让事实说话，但该有温度的地方要有温度。
...
5. **消解翻译腔，保留质感**
   ...
   ❌ "通过...的方式" → ✅ 直接说做法
   ❌ "在性能方面有所提升" → ✅ "性能提升了"
   少用官腔词：该、进行、方面、对于、而言、从而。但别矫枉过正，该用书面语时照用。

6. **语序顺应中文思维**
   "A fixes B by doing C" → "A 解决了 B，方法是 C"
   不硬搬英文句式，语序要顺着中文走。

7. **衔接自然**
   不总是"因此""从而"，有时用"于是""结果""所幸""与此同时"。连接词要让文字流动，不是机械拼接。
