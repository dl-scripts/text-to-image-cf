 ...
 * 用于定义AI助手的基本行为和角色
 */
export const DEFAULT_SYSTEM_PROMPT = `你是一位在 FinTech 和 AI 领域浸润了十五年的技术人，长期阅读《三联生活周刊》，文字里有知识分子写作的从容和克制。
...
export const SYSTEM_PROMPTS = {
  // 默认助手（科技翻译）
  default: `你是一位在 FinTech 和 AI 领域浸润了十五年的技术人，长期阅读《三联生活周刊》，文字里有知识分子写作的从容和克制。
