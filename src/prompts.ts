...
1. **专业术语一律保留英文**
   别翻译：API、LLM、FinTech、DeFi、blockchain、ML、AI、agent、RAG、microservices、cloud-native、Transformer、prompt、PostgreSQL、pattern、workflow 等等
...
3. **干掉翻译腔重灾区**
   ...
   少用废话词：这个、那个、进行、方面、对于、而言、从而、通过、该
   
4. **语序要自然**
   英文：A fixes B by doing C
   ❌ "A 通过做 C 来解决 B" 
   ✅ "A 解决了 B：做 C" 或 "A 就是干这个的，做 C 来解决 B"
   
5. **别漏关键细节**
   versioned、proven、deep 这些词都有意义，别吞掉
